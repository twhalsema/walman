CREATE PLUGGABLE DATABASE walmandb
        ADMIN USER walman IDENTIFIED BY Temporary1
        ROLES = (dba)
        DEFAULT TABLESPACE walmandata
        DATAFILE '/opt/oracle/oradata/FREE/walmandb/walmandata01' SIZE 500M AUTOEXTEND ON
        FILE_NAME_CONVERT = ('/opt/oracle/oradata/FREE/pdbseed/','/opt/oracle/oradata/FREE/walmandb/');
        ALTER PLUGGABLE DATABASE walmandb OPEN;
        ALTER PLUGGABLE DATABASE walmandb SAVE STATE;

CREATE PLUGGABLE DATABASE testpdb1
        ADMIN USER testadm1 IDENTIFIED BY Temporary1
        ROLES = (dba)
        DEFAULT TABLESPACE testpdb1data
        DATAFILE '/opt/oracle/oradata/FREE/testpdb1/testpdb1data01.dbf' SIZE 100M AUTOEXTEND ON
        FILE_NAME_CONVERT = ('/opt/oracle/oradata/FREE/pdbseed/','/opt/oracle/oradata/FREE/testpdb1/');
        ALTER PLUGGABLE DATABASE testpdb1 OPEN;
        ALTER PLUGGABLE DATABASE testpdb1 SAVE STATE;
		
CREATE PLUGGABLE DATABASE testpdb2
        ADMIN USER testadm2 IDENTIFIED BY Temporary1
        ROLES = (dba)
        DEFAULT TABLESPACE testpdb2data
        DATAFILE '/opt/oracle/oradata/FREE/testpdb2/testpdb2data01.dbf' SIZE 100M AUTOEXTEND ON
        FILE_NAME_CONVERT = ('/opt/oracle/oradata/FREE/pdbseed/','/opt/oracle/oradata/FREE/testpdb2/');
        ALTER PLUGGABLE DATABASE testpdb2 OPEN;
        ALTER PLUGGABLE DATABASE testpdb2 SAVE STATE;
...
ALTER SESSION SET CONTAINER=walmandb;
	...
	ALTER USER walman QUOTA UNLIMITED ON walmandata;
		...
		INSERT INTO walman.credentials (cred_id, cred_name, cred_db_host_name, cred_db_port, cred_db_service, cred_passmgr_entry)
			VALUES (1,'TESTPDB1_TESTUSER11','walmandbserver.example.com',1521,'testpdb1','ORACLE - TESTPDB1 - TESTUSER11');
		INSERT INTO walman.credentials (cred_id, cred_name, cred_db_host_name, cred_db_port, cred_db_service, cred_passmgr_entry)
			VALUES (2,'TESTPDB1_TESTUSER12','walmandbserver.example.com',1521,'testpdb1','ORACLE - TESTPDB1 - TESTUSER12');
		INSERT INTO walman.credentials (cred_id, cred_name, cred_db_host_name, cred_db_port, cred_db_service, cred_passmgr_entry)
			VALUES (3,'TESTPDB1_TESTUSER13','walmandbserver.example.com',1521,'testpdb1','ORACLE - TESTPDB1 - TESTUSER13');
		INSERT INTO walman.credentials (cred_id, cred_name, cred_db_host_name, cred_db_port, cred_db_service, cred_passmgr_entry)
			VALUES (4,'TESTPDB1_TESTUSER14','walmandbserver.example.com',1521,'testpdb1','ORACLE - TESTPDB1 - TESTUSER14');
		INSERT INTO walman.credentials (cred_id, cred_name, cred_db_host_name, cred_db_port, cred_db_service, cred_passmgr_entry)
			VALUES (5,'TESTPDB2_TESTUSER21','walmandbserver.example.com',1521,'testpdb2','ORACLE - TESTPDB2 - TESTUSER21');
		INSERT INTO walman.credentials (cred_id, cred_name, cred_db_host_name, cred_db_port, cred_db_service, cred_passmgr_entry)
			VALUES (6,'TESTPDB2_TESTUSER22','walmandbserver.example.com',1521,'testpdb2','ORACLE - TESTPDB2 - TESTUSER22');
		INSERT INTO walman.credentials (cred_id, cred_name, cred_db_host_name, cred_db_port, cred_db_service, cred_passmgr_entry)
			VALUES (7,'TESTPDB2_TESTUSER23','walmandbserver.example.com',1521,'testpdb2','ORACLE - TESTPDB2 - TESTUSER23');
		INSERT INTO walman.credentials (cred_id, cred_name, cred_db_host_name, cred_db_port, cred_db_service, cred_passmgr_entry)
			VALUES (8,'TESTPDB2_TESTUSER24','walmandbserver.example.com',1521,'testpdb2','ORACLE - TESTPDB2 - TESTUSER24');
		COMMIT;
		...
		INSERT INTO walman.wallet_sites(wallet_id, site_host_name, site_directory, site_owner) VALUES (1,'walmandbclient1.example.com','/home/oracle/wallets/all_test_dbs_and_users','oracle');
		INSERT INTO walman.wallet_sites(wallet_id, site_host_name, site_directory, site_owner) VALUES (1,'walmandbclient2.example.com','/home/oracle/wallets/all_test_dbs_and_users','oracle');
		INSERT INTO walman.wallet_sites(wallet_id, site_host_name, site_directory, site_owner) VALUES (2,'walmandbclient1.example.com','/home/oracle/wallets/testpdb1_users','oracle');
		INSERT INTO walman.wallet_sites(wallet_id, site_host_name, site_directory, site_owner) VALUES (2,'walmandbclient2.example.com','/home/oracle/wallets/testpdb1_users','oracle');
		COMMIT;
